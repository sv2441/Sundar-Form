...
if 'youtube_api_key' not in st.session_state:
    st.session_state.youtube_api_key = "AIzaSyCoV5F0HWYKWvm_PZCZwGDw1hw0P7kFIsc"
if 'gemini_api_key' not in st.session_state:
    st.session_state.gemini_api_key = "AIzaSyCcZlPRNq_Ouw0fXdk-kWeuXZ1bvoyOF_A"
                ...
                with tab2:
                    ...
                    if st.session_state['analyzed_youtube_results']:
                        ...
                        if selected_video_index is not None:
                            ...
                            # Use Raw Dark Pattern Analysis for the collapsible view
